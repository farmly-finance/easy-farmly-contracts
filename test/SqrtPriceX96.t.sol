...
contract SqrtPriceX96Test is Test {
    ...
    function test_encodeSqrtPriceX96() public {
        uint256 sqrtPriceX96 = SqrtPriceX96.encodeSqrtPriceX96(
            price,
            token0Decimal,
            token1Decimal
        );
    ...
    function test_decodeSqrtPriceX96() public {
        uint256 decodedPrice = SqrtPriceX96.decodeSqrtPriceX96(
            2505352955026066883383046,
            token0Decimal,
            token1Decimal
        );
        ...
        assertEq(
            SqrtPriceX96.decodeSqrtPriceX96(type(uint160).max, 1, 18),
            3402823669209384634633746074317682114559
        );
        assertEq(
